    ...
    stages {
        ...
        stage('test') {
            ...
            steps {
                ...
                sh 'sh artifactory-get.sh -r http://artifactory-sdc.onsdigital.uk/artifactory/libs-release-local/ -g uk.gov.ons.ctp.product -a casesvc > target/casesvc.jar'
                sh 'chmod 777 target/casesvc.jar'
